...
import mp3 from "@/assets/images/others/mp3-dark.png";
import mp3W from "@/assets/images/others/mp3.png";
import Image from "next/image";

function TeamChat() {
	return (
		<div className="flex w-full flex-col justify-between rounded-lg bg-white dark:border dark:border-darkblack-400 dark:bg-darkblack-600 lg:w-1/2 ">
